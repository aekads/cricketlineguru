...
async function scrapeAndPush() {
  const url = 'https://cricketlineguru.com/match-detail/nmpl_2025_25/commentary/sanpada-scorpions-vs-vashi-warriors-25th-match';
  ...
  try {
    ...
    // Ensure Anonymous Authentication before Writing
const user = await admin.auth().createUser({
  ...
  if (err.code === 'auth/uid-already-exists') {
    ...
    return { uid: "anonymous-user" }; // Use existing user
  }
  throw err;
});
